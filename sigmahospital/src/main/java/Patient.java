...
public class Patient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblpno.setFont(new java.awt.Font(".AppleSystemUIFont", 1, 15)); // NOI18N
        lblpno.setText("No.");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            pst = connection.prepareStatement("delete from patient where patientno = ?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst = connection.prepareStatement("insert into patient(patientno, name, phone, address)values(?, ?, ?, ?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            pst = connection.prepareStatement("update patient set name = ?, phone = ?, address = ? where patientno = ?");
